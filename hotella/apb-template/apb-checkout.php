...
get_header(); ?>
<!-- webnus -->
<div class="hotella-awe-checkout">
<?php do_action( 'apb_renderBefore' ); ?>
		...
		<div class="apb-layout apb-sidebar-left">
			...
			<div class="apb-widget-area">
				<div class="apb-room-selected">
					<!-- HEADING -->
					<h2 class="apb-heading"><?php esc_html_e( 'Your booking', 'hotella' ) ?></h2>
					<!-- END / HEADING -->
			...
			<div class="apb-content-area">
				...
				if ( ! empty( $apb_cart ) ) {
					...
					?>
				<?php } else { ?>
					<a href="<?php echo esc_url( AWE_function::get_check_available_page() ) ?>"><?php esc_html_e( 'No Item. Return to Check Availability form!', 'hotella' ); ?></a>
				<?php } ?>
