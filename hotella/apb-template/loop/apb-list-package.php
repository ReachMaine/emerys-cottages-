...
?>
	...
	<div class="wn-apb-room_package-content" id="apb-room_packge-<?php the_ID(); ?>">
				...
				<div class="apb-package_img">
					...
					<div class="apb-package_text">
						<h4>
							...
							?>
					<label for="package-<?php echo esc_attr( $item_option->id ) ?>">
						<i class="<?php echo isset( $item_option->option_icon ) ? $item_option->option_icon : '' ?>"></i>
