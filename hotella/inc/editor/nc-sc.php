...
class Hotella_Webnus_MyGallery
{
	...
	function filter_mce_plugin( $plugins ) {
		// this plugin file will work the magic of our button
                ...
                $plugins['hotella_webnus_button'] = get_template_directory_uri() . '/inc/editor/nc-sc.js';
...
$mygallery = new Hotella_Webnus_MyGallery();
