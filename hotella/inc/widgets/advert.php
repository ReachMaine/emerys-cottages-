<?php class WebnusAdvertisementWidget extends WP_Widget{
	...
	public function form($instance){
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id('link') ) ?>"><?php esc_html_e('Ad link URL:','hotella') ?></label><input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id('link') ) ?>" name="<?php echo esc_attr( $this->get_field_name('link') ) ?>" value="<?php if( isset($link) )  echo esc_attr($link); ?>" /></p>
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id('html_content') ) ?>"><?php esc_html_e('Html content:','hotella') ?></label><textarea class="widefat" id="<?php echo esc_attr( $this->get_field_id('html_content') ) ?>" name="<?php echo esc_attr( $this->get_field_name('html_content') ) ?>"><?php if( isset($html_content) )  echo esc_attr($html_content); ?></textarea></p>
		<?php 
	}
...
add_action('widgets_init','register_hotella_webnus_advertisement_widget'); 
function register_hotella_webnus_advertisement_widget(){
