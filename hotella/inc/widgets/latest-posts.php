...
class Hotella_Webnus_LatestPosts extends WP_Widget{
	function __construct(){
		$params = array('description'=> 'Display Latest Posts','name'=> 'Webnus-Latest Posts');
		parent::__construct('Hotella_Webnus_LatestPosts', '', $params);
	}
...
add_action('widgets_init', 'register_hotella_webnus_LatestPosts');
function register_hotella_webnus_LatestPosts(){
	register_widget('Hotella_Webnus_LatestPosts');	
}