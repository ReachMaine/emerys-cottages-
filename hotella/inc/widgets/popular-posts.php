...
class Hotella_Webnus_PopularPosts extends WP_Widget{
	function __construct(){
	$params = array('description'=> 'Display Popular Posts','name'=> 'Webnus-Popular Posts');
	parent::__construct('Hotella_Webnus_PopularPosts', '', $params);
	}
	...
	public function widget($args, $instance){	
		...
		?>
		  <li>
		  <?php get_the_image( array( 'meta_key' => array( 'Full', 'Full' ), 'size' => 'hotella_webnus_tabs_img' ) ); ?>
...
add_action('widgets_init', 'register_hotella_webnus_PopularPosts');
function register_hotella_webnus_PopularPosts(){
	register_widget('Hotella_Webnus_PopularPosts');
}