<?php
	...
	$hotella_webnus_options['hotella_webnus_blog_page_title_enable'] = isset($hotella_webnus_options['hotella_webnus_blog_page_title_enable']) ? $hotella_webnus_options['hotella_webnus_blog_page_title_enable'] : '' ;
	$hotella_webnus_options['hotella_webnus_blog_page_title'] = isset($hotella_webnus_options['hotella_webnus_blog_page_title']) ? $hotella_webnus_options['hotella_webnus_blog_page_title'] : '' ;
...
<?php // start headline
	if($hotella_webnus_options['hotella_webnus_blog_page_title_enable']){
		echo'<section id="headline"><div class="container"><h2>'. $hotella_webnus_options['hotella_webnus_blog_page_title'] .'</h2></div></section>';
	} // end headline ?>
