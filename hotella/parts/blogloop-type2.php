...
<?php
	$featured_enable = $hotella_webnus_options['hotella_webnus_blog_featuredimage_enable'];
...
// Post Title
if( $hotella_webnus_options['hotella_webnus_blog_posttitle_enable'] && $post_format !='aside' && $post_format !='quote') { 	
	if( 'link' == $post_format ) {
...
// Post Content
		if($post_format == 'quote' ) echo '<blockquote>';
			...
			echo '<p>'.hotella_webnus_excerpt(($hotella_webnus_options['hotella_webnus_blog_excerpt_list'])?$hotella_webnus_options['hotella_webnus_blog_excerpt_list']:35).'</p>';
			echo '<a class="readmore" href="' . get_permalink($post->ID) . '">' . esc_html($hotella_webnus_options['hotella_webnus_blog_readmore_text']) . '</a>';

		if($post_format == 'quote') echo '</blockquote>';
		if($post_format == ('quote') || $post_format == 'aside' )
			echo '<a class="readmore" href="'. get_permalink( get_the_ID() ) . '">' . esc_html__('View Post', 'hotella') . '</a>';
	?>	
