<?php
	...
	$hotella_webnus_options['hotella_webnus_blog_posttitle_enable'] = isset($hotella_webnus_options['hotella_webnus_blog_posttitle_enable']) ? $hotella_webnus_options['hotella_webnus_blog_posttitle_enable'] : '' ;
	...
	$hotella_webnus_options['hotella_webnus_no_image'] = isset($hotella_webnus_options['hotella_webnus_no_image']) ? $hotella_webnus_options['hotella_webnus_no_image'] : '' ;
	$hotella_webnus_options['hotella_webnus_blog_excerptfull_enable'] = isset($hotella_webnus_options['hotella_webnus_blog_excerptfull_enable']) ? $hotella_webnus_options['hotella_webnus_blog_excerptfull_enable'] : '' ;
	$hotella_webnus_options['hotella_webnus_blog_excerpt_large'] = isset($hotella_webnus_options['hotella_webnus_blog_excerpt_large']) ? $hotella_webnus_options['hotella_webnus_blog_excerpt_large'] : '' ;
...
<div class="blog-inner">
	...
	<div class="blgt1-top-sec">
		...
		<div class="blog1-header-wrap">
			...
			if ( $post_format != 'quote' ) {
				if( $hotella_webnus_options['hotella_webnus_blog_meta_gravatar_enable'] ) { ?>
					<div class="au-avatar-box">
						<div class="au-avatar"><?php echo get_avatar( get_the_author_meta( 'user_email' ), 90 ); ?></div>
					</div>
				<?php } ?>
				<h6 class="blog-author"><?php esc_html_e('Posted by:','hotella') . the_author_posts_link(); ?></h6>
				<h6 class="blog-date"><a href="<?php the_permalink(); ?>"><?php the_time(get_option( 'date_format' )) ?></a></h6>
				<h6 class="blog-cat"><?php esc_html_e('in:','hotella') . the_category(', '); ?></h6>
			<?php } ?>
		</div>
	</div>
	...
	if( $hotella_webnus_options['hotella_webnus_blog_featuredimage_enable'] ) {
		...
		// gallery post type
			...
			if(has_post_thumbnail()){
				...
				if($hotella_webnus_options['hotella_webnus_no_image']){
					$no_image_src = isset( $hotella_webnus_options['hotella_webnus_no_image_src']['url'] ) ? $hotella_webnus_options['hotella_webnus_no_image_src']['url'] : get_template_directory_uri() . '/images/no_image.jpg';
	...
	<div class="blgt1-inner">
	 <?php
	  if( 0 == $hotella_webnus_options['hotella_webnus_blog_excerptfull_enable'] ) {
			if( 'quote' == $post_format  ) echo '<blockquote>';
			echo '<p>';
			echo hotella_webnus_excerpt(($hotella_webnus_options['hotella_webnus_blog_excerpt_large'])?$hotella_webnus_options['hotella_webnus_blog_excerpt_large']:93);
			echo '... <br><br><a class="readmore" href="' . get_permalink($post->ID) . '">' . esc_html($hotella_webnus_options['hotella_webnus_blog_readmore_text']) . '</a>';
			echo '</p>';
			if( 'quote' == $post_format  ) echo '</blockquote>';
		} else {
			if( 'quote' == $post_format  ) echo '<blockquote>';
	...
	<?php if( 1 == $hotella_webnus_options['hotella_webnus_blog_social_share'] ) {
